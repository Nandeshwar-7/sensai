  ...
  return (
    <div>
              ...
              {faqs.map((faq, index) => {
                return (
                  <AccordionItem key={index} value={`item-${index}`}>
                    <AccordionTrigger><span className="font-bold text-xl">{faq.question}</span></AccordionTrigger>
                    <AccordionContent>
                      {faq.answer}
                    </AccordionContent>
                  </AccordionItem>
      ...
      <section className="w-full">
        <div className="mx-auto py-24 gradient rounded-lg bg-gradient-to-b from-slate-50 to-slate-300">
